...
/**
 * Project: Interviews Package: VerifyPreorderSequenceInBinarySearchTree Date:
 * 12/Sep/2015 Time: 11:17 System Time: 11:17 AM
 */
...
public class Solution {
    ...
    // just push the new one onto the stack. But before that, pop all smaller
    // ancestor values, as we must now be in their right subtrees (or even further,
    // in the right subtree of an ancestor). Also, use the popped values as a lower
    // bound, since being in their right subtree means we must never come across a
    // smaller number anymore.
