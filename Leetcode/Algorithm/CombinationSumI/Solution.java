...
/*
    ...
    From: http://blog.csdn.net/kenden23/article/details/17097199
 */
...
public class Solution {
    ...
    public void combinationSum(int[] candidates, int cur, int target, List<Integer> partialres, List<List<Integer>> res) {
        if (target == 0) {
